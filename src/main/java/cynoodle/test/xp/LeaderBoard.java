...
public final class LeaderBoard {
    ...
    private final Map<UReference, Entry> members;
    ...
    public final static class Entry {
        ...
        private UReference member;

        private long xp;

        private int rank;

        private Entry(@Nonnull UReference member, long xp, int rank) {
            this.member = member;
            this.xp = xp;
            this.rank = rank;
        }
