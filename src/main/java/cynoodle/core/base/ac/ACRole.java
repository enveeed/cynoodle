 ...
 * @see AccessControl
 */
public final class ACRole implements Bsonable {
    private ACRole() {}
    ...
    ACRole(@Nonnull DiscordPointer role) {
        this.role = role;
    }
    ...
    @Nonnull
    static Function<BsonValue, ACRole> load() {
        return value -> {
    ...
    @Nonnull
    static Function<ACRole, BsonValue> store() {
