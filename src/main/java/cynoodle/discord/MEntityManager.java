...
public class MEntityManager<E extends MEntity> extends EntityManager<E> {
    ...
    @Nonnull
    public final E create(@Nonnull GReference guild, @Nonnull UReference user, @Nonnull Consumer<E> action) {
        return this.create(((Consumer<E>) e -> e.setMember(guild, user)).andThen(action));
    }

    @Nonnull
    public final E create(@Nonnull GReference guild, @Nonnull UReference user) {
        return this.create(guild, user, e -> {});
    }

    @Nonnull
    public final E create(@Nonnull Guild guild, @Nonnull User user, @Nonnull Consumer<E> action) {
        return this.create(GReference.to(guild), UReference.to(user) , action);
    }
    ...
    @Nonnull
    public final E firstOrCreate(@Nonnull GReference guild, @Nonnull UReference user, @Nonnull Bson filter, @Nonnull Consumer<E> action) {
    ...
    @Nonnull
    public final E firstOrCreate(@Nonnull GReference guild, @Nonnull UReference user, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(MEntity.filterMember(guild, user),
                ((Consumer<E>) e -> e.setMember(guild, user)).andThen(action));
    }

    @Nonnull
    public final E firstOrCreate(@Nonnull GReference guild, @Nonnull UReference user) {
    ...
    public final E firstOrCreate(@Nonnull Guild guild, @Nonnull User user, @Nonnull Bson filter, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(GReference.to(guild), UReference.to(user), filter, action);
    }

    @Nonnull
    public final E firstOrCreate(@Nonnull Guild guild, @Nonnull User user, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(GReference.to(guild), UReference.to(user), action);
    }
