...
public class GEntityManager<E extends GEntity> extends EntityManager<E> {
    ...
    @Nonnull
    public final E create(@Nonnull GReference guild, @Nonnull Consumer<E> action) {
        return this.create(((Consumer<E>) e -> e.setGuild(guild)).andThen(action));
    }

    @Nonnull
    public final E create(@Nonnull GReference guild) {
        return this.create(guild, e -> {});
    }

    @Nonnull
    public final E create(@Nonnull Guild guild, @Nonnull Consumer<E> action) {
        return this.create(GReference.to(guild), action);
    }
    ...
    @Nonnull
    public final E firstOrCreate(@Nonnull GReference guild, @Nonnull Bson filter, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(Filters.and(GEntity.filterGuild(guild), filter),
                ((Consumer<E>) e -> e.setGuild(guild)).andThen(action));
    }

    @Nonnull
    public final E firstOrCreate(@Nonnull GReference guild, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(GEntity.filterGuild(guild),
                ((Consumer<E>) e -> e.setGuild(guild)).andThen(action));
    }

    @Nonnull
    public final E firstOrCreate(@Nonnull GReference guild) {
    ...
    public final E firstOrCreate(@Nonnull Guild guild, @Nonnull Bson filter, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(GReference.to(guild), filter, action);
    }

    @Nonnull
    public final E firstOrCreate(@Nonnull Guild guild, @Nonnull Consumer<E> action) {
        return this.firstOrCreate(GReference.to(guild), action);
    }
    ...
    @Nonnull
    public final Stream<E> stream(@Nonnull GReference guild, @Nonnull Bson filter) {
        return stream(Filters.and(GEntity.filterGuild(guild), filter));
    }

    @Nonnull
    public final Stream<E> stream(@Nonnull GReference guild) {
        return stream(guild, DEFAULT_FILTER);
    }

    @Nonnull
    public final Stream<E> stream(@Nonnull Guild guild, @Nonnull Bson filter) {
        return stream(GReference.to(guild), filter);
    }
