...
import cynoodle.test.commands.CommandContext;
...
public final class Members {
    ...
    @Nonnull
    public static MFormatter formatAt(@Nonnull GReference guild) {
        return new MFormatter(guild);
    }

    @Nonnull
    public static MFormatter formatAt(@Nonnull Guild guild) {
        return new MFormatter(GReference.to(guild));
    }

    @Nonnull
    public static MFormatter formatOf(@Nonnull CommandContext context) {
        return new MFormatter(GReference.to(context.getGuildPointer().getID()));
    }
