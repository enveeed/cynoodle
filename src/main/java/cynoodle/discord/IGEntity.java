...
public interface IGEntity extends IEntity {
     ...
     */
    @Nonnull
    default GReference requireGuild() throws IllegalStateException {
     ...
     */
    void setGuild(@Nullable GReference guild);
    ...
    default void setGuild(@Nullable Guild guild) {
        setGuild(guild == null ? null : GReference.to(guild));
    }
